import type { ExternalOption, InputOption, InternalModuleFormat, ModuleFormat, OutputOptions, Plugin, RollupOptions, RollupOutput, RollupWarning, RollupWatcher, WarningHandler, WatcherOptions } from 'rollup';
...
export interface ResolvedBuildOptions extends Required<Omit<BuildOptions, 'polyfillModulePreload'>> {
    modulePreload: false | ResolvedModulePreloadOptions;
}
export declare function resolveBuildOptions(raw: BuildOptions | undefined, logger: Logger, root: string): ResolvedBuildOptions;
...
export declare function resolveLibFilename(libOptions: LibraryOptions, format: ModuleFormat, entryName: string, root: string, extension?: JsExt, packageCache?: PackageCache): string;
...
export declare function resolveUserExternal(user: ExternalOption, id: string, parentId: string | undefined, isResolved: boolean): boolean | null | void;
