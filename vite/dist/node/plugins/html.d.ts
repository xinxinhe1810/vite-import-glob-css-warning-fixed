...
export declare const htmlProxyMap: WeakMap<Readonly<Omit<import("../config").UserConfig, "plugins" | "css" | "assetsInclude" | "optimizeDeps" | "worker"> & {
...
} & import("../config").PluginHookUtils>, Map<string, {
    code: string;
...
export declare const isAsyncScriptMap: WeakMap<Readonly<Omit<import("../config").UserConfig, "plugins" | "css" | "assetsInclude" | "optimizeDeps" | "worker"> & {
    configFile: string | undefined;
    configFileDependencies: string[];
    inlineConfig: import("../config").InlineConfig;
    root: string;
    ...
    appType: import("../config").AppType;
    experimental: import("../config").ExperimentalOptions;
} & import("../config").PluginHookUtils>, Map<string, boolean>>;
export declare function nodeIsElement(node: DefaultTreeAdapterMap['node']): node is DefaultTreeAdapterMap['element'];
export declare function traverseHtml(html: string, filePath: string, visitor: (node: DefaultTreeAdapterMap['node']) => void): Promise<void>;
...
export declare function overwriteAttrValue(s: MagicString, sourceCodeLocation: Token.Location, newValue: string): MagicString;
/**
...
export type IndexHtmlTransformHook = (this: void, html: string, ctx: IndexHtmlTransformContext) => IndexHtmlTransformResult | void | Promise<IndexHtmlTransformResult | void>;
...
export declare function preImportMapHook(config: ResolvedConfig): IndexHtmlTransformHook;
/**
 ...
 */
export declare function htmlEnvHook(config: ResolvedConfig): IndexHtmlTransformHook;
export declare function resolveHtmlTransforms(plugins: readonly Plugin[]): [
