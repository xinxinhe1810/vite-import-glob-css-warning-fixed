...
import { C as colors, D as bindShortcuts, x as createLogger, h as resolveConfig } from './chunks/dep-ae4c77d8.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./chunks/dep-ae4c77d8.js').then(function (n) { return n.I; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('./chunks/dep-ae4c77d8.js').then(function (n) { return n.H; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('./chunks/dep-ae4c77d8.js').then(function (n) { return n.G; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('./chunks/dep-ae4c77d8.js').then(function (n) { return n.J; });
    try {
