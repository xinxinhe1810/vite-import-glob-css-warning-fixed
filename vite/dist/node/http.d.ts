...
/// <reference types="node" />
import type { Server as HttpServer, OutgoingHttpHeaders as HttpServerHeaders } from 'node:http';
...
export declare function resolveHttpsConfig(https: boolean | HttpsServerOptions | undefined): Promise<HttpsServerOptions | undefined>;
...
export declare function setClientErrorHandler(server: HttpServer, logger: Logger): void;
